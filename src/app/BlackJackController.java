...
public class BlackJackController {
	...
	public void load1() {
		try {
			...
			number = "1";
			onStartNewGame(loader.getIdentifier(), loader.getPenger());
			backFromLoadButton.setVisible(false);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public void load2() {
		try {
			...
			number = "2";
			onStartNewGame(loader2.getIdentifier(), loader2.getPenger());
			backFromLoadButton.setVisible(false);
		} catch (Exception e) {
			e.printStackTrace();
			info.setText("Can't load");
	...
	public void load3() {
		try {
			...
			number = "3";
			onStartNewGame(loader3.getIdentifier(), loader3.getPenger());
			backFromLoadButton.setVisible(false);
		} catch (Exception e) {
			e.printStackTrace();
			info.setText("Can't load");
	...
	public void load4() {
		try {
			...
			number = "4";
			onStartNewGame(loader4.getIdentifier(), loader4.getPenger());
			backFromLoadButton.setVisible(false);
		} catch (Exception e) {
			e.printStackTrace();
			info.setText("Can't load");
